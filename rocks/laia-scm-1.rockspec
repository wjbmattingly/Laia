...
build = {
  ...
  modules = {
    ...
    ["laia.WidthBatcher"] = "laia/WidthBatcher.lua",
    ...
    ["laia.cudnn"] = "laia/cudnn/init.lua",
    ["laia.cudnn.PoolingHWNC"] = "laia/cudnn/PoolingHWNC.lua",
    ["laia.cudnn.SpatialConvolutionHWNC"] = "laia/cudnn/SpatialConvolutionHWNC.lua",
    ["laia.cudnn.SpatialMaxPoolingHWNC"] = "laia/cudnn/SpatialMaxPoolingHWNC.lua",
    ...
    ["laia.util.mem"] = "laia/util/mem.lua",
